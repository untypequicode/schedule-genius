...
bool DictDynCharInt::IfValue(unsigned int index, std::string condition, int value)
{
    if(condition == "==" or condition == "=" or condition == "is")
...
bool DictDynCharInt::IfKey(unsigned int index, std::string condition, char value)
{
    if (condition == "=" or condition == "==" or condition == "is")
